...
__decorate([
    (0, typeorm_1.Column)({ type: "varchar", length: 255, nullable: true }),
    __metadata("design:type", String)
], Song.prototype, "musician", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: "varchar", length: 255, nullable: true }),
    __metadata("design:type", String)
], Song.prototype, "songUrl", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: "varchar", length: 255, nullable: true }),
    __metadata("design:type", String)
], Song.prototype, "imageUrl", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Album_1.Album, (album) => album.id),
    __metadata("design:type", Album_1.Album)
], Song.prototype, "album", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => playlist_1.Playlist, (playlist) => playlist.id),
